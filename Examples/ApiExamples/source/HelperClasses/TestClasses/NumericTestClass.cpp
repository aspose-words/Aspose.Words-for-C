...
RTTI_INFO_IMPL_HASH(989380276u, ::Aspose::Words::ApiExamples::TestData::TestClasses::NumericTestClass, ThisTypeBaseTypesInfo);

System::Nullable<int32_t> NumericTestClass::get_Value1() const
{
    return pr_Value1;
}
...
double NumericTestClass::get_Value2() const
{
    return pr_Value2;
}
...
int32_t NumericTestClass::get_Value3() const
{
    return pr_Value3;
}
...
System::Nullable<int32_t> NumericTestClass::get_Value4() const
{
    return pr_Value4;
}
...
bool NumericTestClass::get_Logical() const
{
    return pr_Logical;
}
...
System::DateTime NumericTestClass::get_Date() const
{
    return pr_Date;
}
