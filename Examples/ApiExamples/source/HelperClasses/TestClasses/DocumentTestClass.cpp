...
RTTI_INFO_IMPL_HASH(3341162896u, ::Aspose::Words::ApiExamples::TestData::TestClasses::DocumentTestClass, ThisTypeBaseTypesInfo);

System::SharedPtr<Aspose::Words::Document> DocumentTestClass::get_Document() const
{
    return pr_Document;
}
...
System::SharedPtr<System::IO::Stream> DocumentTestClass::get_DocumentStream() const
{
...
System::ArrayPtr<uint8_t> DocumentTestClass::get_DocumentBytes() const
{
...
System::String DocumentTestClass::get_DocumentString() const
{
