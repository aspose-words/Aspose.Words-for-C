...
public:
    ...
    void FallbackSettings()
    {
        ...
        ASSERT_EQ(u"0C00-0C7F", rules->idx_get(7)->get_Attributes()->idx_get(u"Ranges")->get_Value());
        ASSERT_EQ(u"Vani", rules->idx_get(7)->get_Attributes()->idx_get(u"FallbackFonts")->get_Value());
    }
