...
System::SharedPtr<System::Globalization::CultureInfo> ExFieldOptions::FieldUpdateCultureProvider::GetCulture(System::String name, System::SharedPtr<Aspose::Words::Fields::Field> field)
{
    if (name == u"ru-RU")
    {
        ...
        format->set_MonthNames(System::MakeArray<System::String>({u"месяц 1", u"месяц 2", u"месяц 3", u"месяц 4", 
            u"месяц 5", u"месяц 6", u"месяц 7", u"месяц 8", u"месяц 9", u"месяц 10", u"месяц 11", u"месяц 12", u""}));
        format->set_MonthGenitiveNames(format->get_MonthNames());
        format->set_AbbreviatedMonthNames(System::MakeArray<System::String>({u"мес 1", u"мес 2", u"мес 3", u"мес 4", 
            u"мес 5", u"мес 6", u"мес 7", u"мес 8", u"мес 9", u"мес 10", u"мес 11", u"мес 12", u""}));
        format->set_AbbreviatedMonthGenitiveNames(format->get_AbbreviatedMonthNames());
        
        format->set_DayNames(System::MakeArray<System::String>({u"день недели 7", u"день недели 1", u"день недели 2", 
            u"день недели 3", u"день недели 4", u"день недели 5", u"день недели 6"}));
        format->set_AbbreviatedDayNames(System::MakeArray<System::String>({u"день 7", u"день 1", u"день 2", u"день 3", 
            u"день 4", u"день 5", u"день 6"}));
...
void ExFieldOptions::CurrentUser()
{
    ...
    doc = System::MakeObject<Aspose::Words::Document>(System::String(get_ArtifactsDir() + u"FieldOptions.CurrentUser.docx"));
...
void ExFieldOptions::FileName()
{
    ...
    doc = System::MakeObject<Aspose::Words::Document>(System::String(get_ArtifactsDir() + u"FieldOptions.FILENAME.docx"));
...
void ExFieldOptions::Bidi()
{
    ...
    doc = System::MakeObject<Aspose::Words::Document>(System::String(get_ArtifactsDir() + u"FieldOptions.Bidi.docx"));
...
void ExFieldOptions::TableOfAuthorityCategories()
{
    ...
    doc = System::MakeObject<Aspose::Words::Document>(System::String(get_ArtifactsDir() + u"FieldOptions.TOA.Categories.docx"));
    ...
    TestUtil::VerifyField(Aspose::Words::Fields::FieldType::FieldTOA, u"TOA \\c 2 \\h", System::String(u"My Category 2\r") + u"entry 1\t2\r" + u"entry 3\t4\r", doc->get_Range()->get_Fields()->idx_get(1));
}
