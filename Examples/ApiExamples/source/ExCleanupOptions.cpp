...
RTTI_INFO_IMPL_HASH(2607401802u, ::Aspose::Words::ApiExamples::ExCleanupOptions, ThisTypeBaseTypesInfo);
...
{
protected:
    static System::SharedPtr<::Aspose::Words::ApiExamples::ExCleanupOptions> s_instance;
    ...
    {
        s_instance = System::MakeObject<::Aspose::Words::ApiExamples::ExCleanupOptions>();
...
System::SharedPtr<::Aspose::Words::ApiExamples::ExCleanupOptions> ExCleanupOptions::s_instance;

} // namespace gtest_test

void ExCleanupOptions::RemoveUnusedResources()
{
    //ExStart
...
void ExCleanupOptions::RemoveDuplicateStyles()
{
    //ExStart
