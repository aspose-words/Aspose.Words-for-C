...
RTTI_INFO_IMPL_HASH(2783345958u, ::Aspose::Words::ApiExamples::DocumentHelper, ThisTypeBaseTypesInfo);
...
System::SharedPtr<Aspose::Words::Document> DocumentHelper::CreateTemplateDocumentWithDrawObjects(System::String templateText, Aspose::Words::Drawing::ShapeType shapeType)
{
    ...
    auto shape = System::MakeObject<Aspose::Words::Drawing::Shape>(doc, shapeType);
    shape->set_Width(431.5);
    shape->set_Height(346.35);
    
    auto paragraph = System::MakeObject<Aspose::Words::Paragraph>(doc);
    paragraph->AppendChild<System::SharedPtr<Aspose::Words::Run>>(System::MakeObject<Aspose::Words::Run>(doc, templateText));
    
    // Insert paragraph into the textbox.
    shape->AppendChild<System::SharedPtr<Aspose::Words::Paragraph>>(paragraph);
...
{
    System::SharedPtr<Aspose::Words::Paragraph> para = GetParagraph(doc, paraIndex);
