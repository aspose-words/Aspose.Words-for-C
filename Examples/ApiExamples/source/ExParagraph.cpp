...
RTTI_INFO_IMPL_HASH(454855134u, ::Aspose::Words::ApiExamples::ExParagraph, ThisTypeBaseTypesInfo);
...
{
protected:
    static System::SharedPtr<::Aspose::Words::ApiExamples::ExParagraph> s_instance;
    ...
    {
        s_instance = System::MakeObject<::Aspose::Words::ApiExamples::ExParagraph>();
...
System::SharedPtr<::Aspose::Words::ApiExamples::ExParagraph> ExParagraph::s_instance;
...
void ExParagraph::DocumentBuilderInsertParagraph()
{
    ...
    System::SharedPtr<Aspose::Words::Font> runFont = paragraph->get_Runs()->idx_get(0)->get_Font();
...
TEST_F(ExParagraph, AppendField)
{
    s_instance->AppendField();
}
...
void ExParagraph::MoveRevisions()
{
    //ExStart
...
TEST_F(ExParagraph, MoveRevisions)
{
...
void ExParagraph::RangeRevisions()
{
    //ExStart
...
TEST_F(ExParagraph, RangeRevisions)
{
    s_instance->RangeRevisions();
}
