...
public:
    ...
    static void TestDocStructureToText(SharedPtr<ExDocumentVisitor::DocStructurePrinter> visitor)
    {
    ...
    static void TestTableToText(SharedPtr<ExDocumentVisitor::TableStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestCommentsToText(SharedPtr<ExDocumentVisitor::CommentStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestFieldToText(SharedPtr<ExDocumentVisitor::FieldStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestHeaderFooterToText(SharedPtr<ExDocumentVisitor::HeaderFooterStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestEditableRangeToText(SharedPtr<ExDocumentVisitor::EditableRangeStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestFootnoteToText(SharedPtr<ExDocumentVisitor::FootnoteStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestOfficeMathToText(SharedPtr<ExDocumentVisitor::OfficeMathStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestSmartTagToText(SharedPtr<ExDocumentVisitor::SmartTagStructurePrinter> visitor)
    {
        String visitorText = visitor->GetText();
    ...
    static void TestStructuredDocumentTagToText(SharedPtr<ExDocumentVisitor::StructuredDocumentTagNodePrinter> visitor)
    {
        String visitorText = visitor->GetText();
