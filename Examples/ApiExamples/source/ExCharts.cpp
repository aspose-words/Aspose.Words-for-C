...
using ExCharts_TestDisplayChartsWithConversion_Args = System::MethodArgumentTuple<decltype(&ApiExamples::ExCharts::TestDisplayChartsWithConversion)>::type;

struct ExCharts_TestDisplayChartsWithConversion : public ExCharts,
                                                  public ApiExamples::ExCharts,
                                                  public ::testing::WithParamInterface<ExCharts_TestDisplayChartsWithConversion_Args>
{
