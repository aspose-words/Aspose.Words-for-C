...
{
protected:
    static System::SharedPtr<::DocsExamples::Programming_with_Documents::Contents_Managment::WorkingWithTableOfContent> s_instance;
    ...
    {
        s_instance = System::MakeObject<::DocsExamples::Programming_with_Documents::Contents_Managment::WorkingWithTableOfContent>();
...
System::SharedPtr<::DocsExamples::Programming_with_Documents::Contents_Managment::WorkingWithTableOfContent> WorkingWithTableOfContent::s_instance;
