...
public:
    void GetEnumerator()
    {
        ...
        ASSERT_EQ(String(u"CN=Aspose Pty Ltd, ") + u"OU=Digital ID Class 3 - Microsoft Software Validation v2, " + u"O=Aspose Pty Ltd, " +
                      u"L=Lane Cove, " + u"S=New South Wales, " + u"C=AU",
