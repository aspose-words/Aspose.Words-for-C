...
public:
    ...
    void InsertHtml()
    {
        ...
        const String html = String(u"<p align='right'>Paragraph right</p>") + u"<b>Implicit paragraph left</b>" +
                                    u"<div align='center'>Div center</div>" + u"<h1 align='left'>Heading 1 left.</h1>";
    ...
    void MathMl()
    {
        ...
        const String mathMl = u"<math "
                                      u"xmlns=\"http://www.w3.org/1998/Math/MathML\"><mrow><msub><mi>a</mi><mrow><mn>1</mn></mrow></msub><mo>+</"
                                      u"mo><msub><mi>b</mi><mrow><mn>1</mn></mrow></msub></mrow></math>";
    ...
    void CreateForm()
    {
        ...
        ArrayPtr<String> items =
            MakeArray<String>({u"-- Select your favorite footwear --", u"Sneakers", u"Oxfords", u"Flip-flops", u"Other"});
    ...
    void InsertTableWithStyle()
    {
        ...
        ASSERT_EQ(189, ASPOSECPP_CHECKED_CAST(int,
                                              table->get_FirstRow()->get_FirstCell()->get_CellFormat()->get_Shading()->get_BackgroundPatternColor().get_B()));
        ...
        ASSERT_NE(
            System::Drawing::Color::get_LightBlue().ToArgb(),
    ...
    void InsertImageOriginalSize()
    {
        ...
        SharedPtr<Shape> imageShape = builder->InsertImage(ImageDir + u"Logo.jpg", RelativeHorizontalPosition::Margin, 0.0,
                                                                   RelativeVerticalPosition::Margin, 0.0, -1.0, -1.0, WrapType::Square);
    ...
    void AppendDocumentAndResolveStyles()
    {
        //ExStart
    ...
    void InsertOleObjectException()
    {
        ...
        // CSPORTCPP: [WARNING] Using local variables. Make sure that local function ptr does not leave the current scope.
        std::function<SharedPtr<Shape>()> _local_func_5 = [&builder]()
        {
            return builder->InsertOleObject(u"", u"checkbox", false, true, nullptr);
        };
    ...
    void InsertPieChart()
    {
        ...
        chart->get_Series()->Add(u"My fruit", MakeArray<String>({u"Apples", u"Bananas", u"Cherries"}),
                                 MakeArray<double>({1.3, 2.2, 1.5}));
...
private:
    ...
    private:
        ...
        public:
            ...
            FormatInvocation(ApiExamples::ExDocumentBuilder::FieldResultFormatter::FormatInvocationType formatInvocationType,
                             SharedPtr<System::Object> value, String originalFormat, String newValue)
    ...
    public:
        FieldResultFormatter(String numberFormat, String dateFormat, String generalFormat)
            : mFormatInvocations(
                  MakeObject<System::Collections::Generic::List<SharedPtr<ExDocumentBuilder::FieldResultFormatter::FormatInvocation>>>())
        {
    ...
    private:
        ...
        SharedPtr<System::Collections::Generic::List<SharedPtr<ExDocumentBuilder::FieldResultFormatter::FormatInvocation>>>
        get_FormatInvocations()
        {
...
public:
    ...
    void InsertOnlineVideoCustomThumbnail()
    {
        ...
        String videoEmbedCode =
            String(u"<iframe src=\"https://player.vimeo.com/video/52477838\" width=\"640\" height=\"360\" frameborder=\"0\" ") +
            u"title=\"Aspose\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";

        {
            auto webClient = MakeObject<System::Net::WebClient>();
            ArrayPtr<uint8_t> thumbnailImageBytes = webClient->DownloadData(AsposeLogoUrl);
        ...
        ASPOSE_ASSERT_EQ(320.0, shape->get_Width());
        ASPOSE_ASSERT_EQ(320.0, shape->get_Height());
        ASPOSE_ASSERT_EQ(-249.15, shape->get_Left());
        ASPOSE_ASSERT_EQ(-249.15, shape->get_Top());
        ASSERT_EQ(WrapType::Square, shape->get_WrapType());
