...
public:
    void SaveAsDoc()
    {
        ...
        ASSERT_THROW(MakeObject<Document>(ArtifactsDir + u"DocSaveOptions.SaveAsDoc.doc"), IncorrectPasswordException);
    ...
    void AlwaysCompressMetafiles(bool compressAllMetafiles)
    {
        ...
        {
            ASSERT_NEAR(13300, MakeObject<System::IO::FileInfo>(ArtifactsDir + u"DocSaveOptions.AlwaysCompressMetafiles.docx")->get_Length(),
                        TestUtil::get_FileInfoLengthDelta());
        }
        else
        {
            ASSERT_NEAR(21500, MakeObject<System::IO::FileInfo>(ArtifactsDir + u"DocSaveOptions.AlwaysCompressMetafiles.docx")->get_Length(),
                        TestUtil::get_FileInfoLengthDelta());
        }
    }
};
