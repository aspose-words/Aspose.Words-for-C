...
String ExMossDoc2Pdf::gInFileName;
String ExMossDoc2Pdf::gOutFileName;
SharedPtr<System::IO::StreamWriter> ExMossDoc2Pdf::gLog;

void ExMossDoc2Pdf::MossDoc2Pdf(ArrayPtr<String> args)
{
...
void ExMossDoc2Pdf::ParseCommandLine(ArrayPtr<String> args)
{
    int i = 0;
...
void ExMossDoc2Pdf::ConvertDoc2Pdf(String inFileName, String outFileName)
{
