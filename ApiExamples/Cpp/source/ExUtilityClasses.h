...
public:
    void PointsAndInches()
    {
        ...
        builder->Writeln(
            ...
            String::Format(u"{0} points/{1} inches from the right, ", pageSetup->get_RightMargin(),
                                   ConvertUtil::PointToInch(pageSetup->get_RightMargin())) +
    ...
    void PointsAndPixels()
    {
        ...
        builder->Writeln(
            ...
            String::Format(u"{0} points/{1} pixels from the right, ", pageSetup->get_RightMargin(),
                                   ConvertUtil::PointToPixel(pageSetup->get_RightMargin())) +
