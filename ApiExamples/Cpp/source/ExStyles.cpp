...
{
protected:
    static SharedPtr<::ApiExamples::ExStyles> s_instance;
    ...
    {
        s_instance = MakeObject<::ApiExamples::ExStyles>();
...
SharedPtr<::ApiExamples::ExStyles> ExStyles::s_instance;
...
void ExStyles::CreateStyle()
{
    ...
    SharedPtr<Style> style = doc->get_Styles()->Add(Aspose::Words::StyleType::Paragraph, u"MyStyle");
...
void ExStyles::StyleCollection()
{
    ...
    SharedPtr<Aspose::Words::StyleCollection> styles = doc->get_Styles();
...
void ExStyles::ChangeStyleOfTocLevel()
{
    auto doc = MakeObject<Document>();
...
TEST_F(ExStyles, ChangeStyleOfTocLevel)
{
...
void ExStyles::ChangeTocsTabStops()
{
    ...
    for (auto para : System::IterateOver(doc->GetChildNodes(Aspose::Words::NodeType::Paragraph, true)->LINQ_OfType<SharedPtr<Paragraph> >()))
    {
...
void ExStyles::CopyStyleDifferentDocument()
{
    ...
    SharedPtr<Style> srcStyle = srcDoc->get_Styles()->Add(Aspose::Words::StyleType::Paragraph, u"MyStyle");
...
void ExStyles::ParagraphStyleBulletedList()
{
    ...
    SharedPtr<Style> style = doc->get_Styles()->Add(Aspose::Words::StyleType::Paragraph, u"MyStyle1");
