...
RTTI_INFO_IMPL_HASH(3182433846u, ::ApiExamples::ExFieldOptions::FieldUpdateCultureProvider, ThisTypeBaseTypesInfo);

SharedPtr<System::Globalization::CultureInfo> ExFieldOptions::FieldUpdateCultureProvider::GetCulture(String name, SharedPtr<Aspose::Words::Fields::Field> field)
{
    ...
    if (switch_value_0 == u"ru-RU")
    {
        ...
        format->set_MonthNames(MakeArray<String>({u"месяц 1", u"месяц 2", u"месяц 3", u"месяц 4", u"месяц 5", u"месяц 6", u"месяц 7", u"месяц 8", u"месяц 9", u"месяц 10", u"месяц 11", u"месяц 12", u""}));
        format->set_MonthGenitiveNames(format->get_MonthNames());
        format->set_AbbreviatedMonthNames(MakeArray<String>({u"мес 1", u"мес 2", u"мес 3", u"мес 4", u"мес 5", u"мес 6", u"мес 7", u"мес 8", u"мес 9", u"мес 10", u"мес 11", u"мес 12", u""}));
        format->set_AbbreviatedMonthGenitiveNames(format->get_AbbreviatedMonthNames());
        format->set_DayNames(MakeArray<String>({u"день недели 7", u"день недели 1", u"день недели 2", u"день недели 3", u"день недели 4", u"день недели 5", u"день недели 6"}));
...
{
protected:
    static SharedPtr<::ApiExamples::ExFieldOptions> s_instance;
    ...
    {
        s_instance = MakeObject<::ApiExamples::ExFieldOptions>();
...
SharedPtr<::ApiExamples::ExFieldOptions> ExFieldOptions::s_instance;

} // namespace gtest_test

void ExFieldOptions::FieldOptionsCurrentUser()
{
    //ExStart
    ...
    auto fieldUserName = System::DynamicCast<Aspose::Words::Fields::FieldUserName>(doc->get_Range()->get_Fields()->idx_get(0));

    ASSERT_TRUE(fieldUserName->get_UserName() == nullptr);
    ASSERT_EQ(u"Default User", fieldUserName->get_Result());

    auto fieldUserInitials = System::DynamicCast<Aspose::Words::Fields::FieldUserInitials>(doc->get_Range()->get_Fields()->idx_get(1));

    ASSERT_TRUE(fieldUserInitials->get_UserInitials() == nullptr);
    ASSERT_EQ(u"D. U.", fieldUserInitials->get_Result());

    auto fieldUserAddress = System::DynamicCast<Aspose::Words::Fields::FieldUserAddress>(doc->get_Range()->get_Fields()->idx_get(2));
...
void ExFieldOptions::FieldOptionsFileName()
{
    //ExStart
    ...
    auto field = System::DynamicCast<Aspose::Words::Fields::FieldFileName>(builder->InsertField(Aspose::Words::Fields::FieldType::FieldFileName, true));
    field->Update();
    ...
    field = System::DynamicCast<Aspose::Words::Fields::FieldFileName>(builder->InsertField(Aspose::Words::Fields::FieldType::FieldFileName, true));
    ...
    TestUtil::VerifyField(Aspose::Words::Fields::FieldType::FieldFileName, u" FILENAME ", u"FieldOptions.FILENAME.docx", doc->get_Range()->get_Fields()->idx_get(0));
}
...
void ExFieldOptions::FieldOptionsBidi()
{
    //ExStart
...
void ExFieldOptions::FieldOptionsLegacyNumberFormat()
{
    //ExStart
    ...
    TestUtil::VerifyField(Aspose::Words::Fields::FieldType::FieldFormula, u"= 2 + 3 \\# $##", u"$5", doc->get_Range()->get_Fields()->idx_get(0));
}
...
void ExFieldOptions::FieldOptionsPreProcessCulture()
{
    //ExStart
...
void ExFieldOptions::FieldOptionsToaCategories()
{
    //ExStart
    ...
    TestUtil::VerifyField(Aspose::Words::Fields::FieldType::FieldTOA, u"TOA \\c 1 \\h", u"My Category 1\rentry 2\t3\r", doc->get_Range()->get_Fields()->idx_get(0));
    TestUtil::VerifyField(Aspose::Words::Fields::FieldType::FieldTOA, u"TOA \\c 2 \\h", String(u"My Category 2\r") + u"entry 1\t2\r" + u"entry 3\t4\r", doc->get_Range()->get_Fields()->idx_get(1));
}
...
void ExFieldOptions::FieldOptionsUseInvariantCultureNumberFormat()
{
    //ExStart
    ...
    ASSERT_FALSE(doc->get_FieldOptions()->get_UseInvariantCultureNumberFormat());
    TestUtil::VerifyField(Aspose::Words::Fields::FieldType::FieldFormula, u" = 1234567,89 \\# $#,###,###.##", u"$1.234.567,89", doc->get_Range()->get_Fields()->idx_get(0));
}
...
void ExFieldOptions::DefineDateTimeFormatting()
{
    ...
    auto fieldDate = System::DynamicCast<Aspose::Words::Fields::FieldTime>(doc->get_Range()->get_Fields()->idx_get(0));
    if (fieldDate->get_LocaleId() != (int)Aspose::Words::EditingLanguage::Russian)
    {
        fieldDate->set_LocaleId((int)Aspose::Words::EditingLanguage::Russian);
    }
