...
public:
    ...
    void InsertField()
    {
        ...
        TestUtil::VerifyField(FieldType::FieldQuote, u" QUOTE \"Real value\"", u"Placeholder value", doc->get_Range()->get_Fields()->idx_get(2));
        TestUtil::VerifyField(FieldType::FieldAuthor, u" AUTHOR ", u"John Doe", doc->get_Range()->get_Fields()->idx_get(3));
        TestUtil::VerifyField(FieldType::FieldQuote, u" QUOTE \"Real value\" ", u"Real value", doc->get_Range()->get_Fields()->idx_get(4));
        TestUtil::VerifyField(FieldType::FieldQuote, u" QUOTE \"Real value\"", u" Placeholder value. ", doc->get_Range()->get_Fields()->idx_get(5));
    }
    ...
    void RevisionHistory()
    {
        ...
        {
            return r->get_RevisionType() == RevisionType::Moving;
        };
        ...
        {
            return (System::DynamicCast<Paragraph>(p))->get_IsMoveFromRevision();
        };
        ...
        {
            return (System::DynamicCast<Paragraph>(p))->get_IsMoveToRevision();
        };
    ...
    void GetFrameProperties()
    {
        ...
        {
            std::cout << (String(u"Width: ") + paragraph->get_FrameFormat()->get_Width()) << std::endl;
            std::cout << (String(u"Height: ") + paragraph->get_FrameFormat()->get_Height()) << std::endl;
            std::cout << (String(u"HeightRule: ") + System::ObjectExt::ToString(paragraph->get_FrameFormat()->get_HeightRule())) << std::endl;
            std::cout << (String(u"HorizontalAlignment: ") + System::ObjectExt::ToString(paragraph->get_FrameFormat()->get_HorizontalAlignment()))
                      << std::endl;
            std::cout << (String(u"VerticalAlignment: ") + System::ObjectExt::ToString(paragraph->get_FrameFormat()->get_VerticalAlignment()))
                      << std::endl;
            std::cout << (String(u"HorizontalPosition: ") + paragraph->get_FrameFormat()->get_HorizontalPosition()) << std::endl;
            std::cout << (String(u"RelativeHorizontalPosition: ") +
                          System::ObjectExt::ToString(paragraph->get_FrameFormat()->get_RelativeHorizontalPosition()))
                      << std::endl;
            std::cout << (String(u"HorizontalDistanceFromText: ") + paragraph->get_FrameFormat()->get_HorizontalDistanceFromText()) << std::endl;
            std::cout << (String(u"VerticalPosition: ") + paragraph->get_FrameFormat()->get_VerticalPosition()) << std::endl;
            std::cout << (String(u"RelativeVerticalPosition: ") +
                          System::ObjectExt::ToString(paragraph->get_FrameFormat()->get_RelativeVerticalPosition()))
                      << std::endl;
            std::cout << (String(u"VerticalDistanceFromText: ") + paragraph->get_FrameFormat()->get_VerticalDistanceFromText()) << std::endl;
        }
        //ExEnd
        ...
        for (auto paragraph : System::IterateOver(paragraphs->LINQ_OfType<SharedPtr<Paragraph>>()->LINQ_Where(
                 static_cast<System::Func<SharedPtr<Paragraph>, bool>>(_local_func_4))))
        {
            ...
            ASSERT_EQ(RelativeHorizontalPosition::Page, paragraph->get_FrameFormat()->get_RelativeHorizontalPosition());
            ...
            ASSERT_EQ(RelativeVerticalPosition::Paragraph, paragraph->get_FrameFormat()->get_RelativeVerticalPosition());
...
protected:
    ...
    /// </summary>
    static void InsertFieldUsingFieldType(SharedPtr<Document> doc, FieldType fieldType, bool updateField, SharedPtr<Node> refNode, bool isAfter,
                                          int paraIndex)
    {
    ...
    /// </summary>
    static void InsertFieldUsingFieldCode(SharedPtr<Document> doc, String fieldCode, SharedPtr<Node> refNode, bool isAfter,
                                          int paraIndex)
    {
        SharedPtr<Paragraph> para = DocumentHelper::GetParagraph(doc, paraIndex);
    ...
    /// </summary>
    static void InsertFieldUsingFieldCodeFieldString(SharedPtr<Document> doc, String fieldCode, String fieldValue,
                                                     SharedPtr<Node> refNode, bool isAfter, int paraIndex)
    {
        SharedPtr<Paragraph> para = DocumentHelper::GetParagraph(doc, paraIndex);
...
public:
    ...
    void TabStops()
    {
        ...
        TestUtil::VerifyTabStop(72.0, TabAlignment::Left, TabLeader::Dots, false, format->get_TabStops()->idx_get(0));
        TestUtil::VerifyTabStop(216.0, TabAlignment::Center, TabLeader::Dashes, false, format->get_TabStops()->idx_get(1));
        TestUtil::VerifyTabStop(360.0, TabAlignment::Right, TabLeader::Line, false, format->get_TabStops()->idx_get(2));
    }
