...
void ExLists::AddOutlineHeadingParagraphs(SharedPtr<Aspose::Words::DocumentBuilder> builder, SharedPtr<Aspose::Words::Lists::List> list, String title)
{
...
void ExLists::TestOutlineHeadingTemplates(SharedPtr<Aspose::Words::Document> doc)
{
...
void ExLists::AddListSample(SharedPtr<Aspose::Words::DocumentBuilder> builder, SharedPtr<Aspose::Words::Lists::List> list)
{
...
void ExLists::TestPrintOutAllLists(SharedPtr<Aspose::Words::Document> listSourceDoc, SharedPtr<Aspose::Words::Document> outDoc)
{
    for (auto list : System::IterateOver(outDoc->get_Lists()))
    {
        for (int i = 0; i < list->get_ListLevels()->get_Count(); i++)
        {
            ...
            SharedPtr<ListLevel> expectedListLevel = listSourceDoc->get_Lists()->LINQ_First(static_cast<System::Func<SharedPtr<List>, bool>>(_local_func_12))->get_ListLevels()->idx_get(i);
...
{
protected:
    static SharedPtr<::ApiExamples::ExLists> s_instance;
    ...
    {
        s_instance = MakeObject<::ApiExamples::ExLists>();
...
SharedPtr<::ApiExamples::ExLists> ExLists::s_instance;
...
void ExLists::ApplyDefaultBulletsAndNumbers()
{
    ...
    TestUtil::VerifyListLevel(u"\u0001.", 54.0, Aspose::Words::NumberStyle::LowercaseLetter, doc->get_Lists()->idx_get(0)->get_ListLevels()->idx_get(1));
    TestUtil::VerifyListLevel(u"\uf0b7", 18.0, Aspose::Words::NumberStyle::Bullet, doc->get_Lists()->idx_get(1)->get_ListLevels()->idx_get(0));
}
...
void ExLists::RestartNumberingUsingListCopy()
{
    ...
    SharedPtr<List> list1 = doc->get_Lists()->Add(Aspose::Words::Lists::ListTemplate::NumberArabicParenthesis);
...
void ExLists::DetectBulletedParagraphs()
{
    ...
    {
        return (System::DynamicCast_noexcept<Aspose::Words::Paragraph>(n))->get_ListFormat()->get_IsListItem();
    };
...
void ExLists::ApplyNewListToParagraphs()
{
    ...
    SharedPtr<List> list = doc->get_Lists()->Add(Aspose::Words::Lists::ListTemplate::NumberUppercaseLetterDot);
    ...
    {
        return (System::DynamicCast_noexcept<Aspose::Words::Paragraph>(n))->get_ListFormat()->get_ListLevelNumber() == 1;
    };
...
void ExLists::OutlineHeadingTemplates()
{
    ...
    SharedPtr<List> list = doc->get_Lists()->Add(Aspose::Words::Lists::ListTemplate::OutlineHeadingsArticleSection);
...
void ExLists::ListDocument()
{
    ...
    SharedPtr<List> list = lists->Add(Aspose::Words::Lists::ListTemplate::BulletDefault);

    ASPOSE_ASSERT_EQ(doc, list->get_Document());

    System::Console::WriteLine(String(u"Current list count: ") + lists->get_Count());
    System::Console::WriteLine(String(u"Is the first document list: ") + (System::ObjectExt::Equals(lists->idx_get(0), list)));
    System::Console::WriteLine(String(u"ListId: ") + list->get_ListId());
    System::Console::WriteLine(String(u"List is the same by ListId: ") + (System::ObjectExt::Equals(lists->GetListByListId(1), list)));
    //ExEnd
...
void ExLists::GetListLabels()
{
    ...
    for (auto paragraph : System::IterateOver(paras->LINQ_OfType<SharedPtr<Paragraph>>()->LINQ_Where([](SharedPtr<Paragraph> p) { return p->get_ListFormat()->get_IsListItem(); })))
    {
        ...
        String paragraphText = paragraph->ToString(Aspose::Words::SaveFormat::Text).Trim();
    ...
    ASSERT_EQ(10, paras->LINQ_OfType<SharedPtr<Paragraph> >()->LINQ_Count(static_cast<System::Func<SharedPtr<Paragraph>, bool>>(_local_func_14)));
}
...
void ExLists::CreatePictureBullet()
{
    ...
    SharedPtr<List> list = doc->get_Lists()->Add(Aspose::Words::Lists::ListTemplate::BulletCircle);
...
TEST_F(ExLists, CreatePictureBullet)
{
