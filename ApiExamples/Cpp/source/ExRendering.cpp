...
RTTI_INFO_IMPL_HASH(2316336368u, ::ApiExamples::ExRendering::HandleDocumentWarnings, ThisTypeBaseTypesInfo);

void ExRendering::HandleDocumentWarnings::Warning(SharedPtr<Aspose::Words::WarningInfo> info)
{
    // We are only interested in fonts being substituted
    if (info->get_WarningType() == Aspose::Words::WarningType::FontSubstitution)
    {
        System::Console::WriteLine(String(u"Font substitution: ") + info->get_Description());
        FontWarnings->Warning(info);
        //ExSkip
    }
}

ExRendering::HandleDocumentWarnings::HandleDocumentWarnings()
     : FontWarnings(MakeObject<WarningInfoCollection>())
{
}

System::Object::shared_members_type ApiExamples::ExRendering::HandleDocumentWarnings::GetSharedMembers()
{
    auto result = System::Object::GetSharedMembers();

    result.Add("ApiExamples::ExRendering::HandleDocumentWarnings::FontWarnings", this->FontWarnings);
...
{
protected:
    static SharedPtr<::ApiExamples::ExRendering> s_instance;
    ...
    {
        s_instance = MakeObject<::ApiExamples::ExRendering>();
...
SharedPtr<::ApiExamples::ExRendering> ExRendering::s_instance;

} // namespace gtest_test

void ExRendering::SaveToPdfWithOutline()
{
    //ExStart
...
void ExRendering::SaveToPdfStreamOnePage()
{
    //ExStart
...
void ExRendering::SaveToPdfNoCompression()
{
    //ExStart
    //ExFor:PdfSaveOptions
    ...
    auto options = MakeObject<PdfSaveOptions>();
    options->set_TextCompression(Aspose::Words::Saving::PdfTextCompression::None);
...
void ExRendering::PdfCustomOptions()
{
    //ExStart
...
void ExRendering::SaveAsXps()
{
    ...
    doc->Save(docStream, Aspose::Words::SaveFormat::Xps);
    docStream->Close();
    ...
    xpsOptions->set_SaveFormat(Aspose::Words::SaveFormat::Xps);
...
void ExRendering::SaveAsXpsBookFold()
{
    //ExStart
    ...
    auto xpsOptions = MakeObject<XpsSaveOptions>(Aspose::Words::SaveFormat::Xps);
...
void ExRendering::SaveToTiffDefault()
{
    auto doc = MakeObject<Document>(MyDir + u"Rendering.docx");
...
void ExRendering::SaveToTiffCompression()
{
    //ExStart
...
void ExRendering::SaveToImageResolution()
{
    //ExStart
...
void ExRendering::SaveToImageJpegQuality()
{
    //ExStart
...
void ExRendering::SaveToImagePaperColor()
{
    //ExStart
    //ExFor:ImageSaveOptions
...
void ExRendering::SaveToImageStream()
{
    //ExStart
    //ExFor:Document.Save(Stream, SaveFormat)
    ...
    auto stream = MakeObject<System::IO::MemoryStream>();
    doc->Save(stream, Aspose::Words::SaveFormat::Bmp);
...
void ExRendering::RenderToSize()
{
...

    {
        ...
        // User has some sort of a Graphics object. In this case created from a bitmap
        {
            ...
            System::Console::WriteLine(u"The image was rendered at {0:P0} zoom.", System::ObjectExt::Box<float>(returnedScale));
...
void ExRendering::UpdatePageLayout()
{
    //ExStart
...
void ExRendering::SetTrueTypeFontsFolder()
{
...
void ExRendering::SetFontsFoldersMultipleFolders()
{
    // Store the font sources currently used so we can restore them later
    ArrayPtr<SharedPtr<FontSourceBase>> fontSources = FontSettings::get_DefaultInstance()->GetFontsSources();
...
void ExRendering::SetFontsFoldersSystemAndCustomFolder()
{
    // Store the font sources currently used so we can restore them later
    ...
    SharedPtr<System::Collections::Generic::List<SharedPtr<FontSourceBase>>> fontSources = MakeObject<System::Collections::Generic::List<SharedPtr<FontSourceBase>>>(FontSettings::get_DefaultInstance()->GetFontsSources());
    ...
    SharedPtr<FolderFontSource> folderSource = (System::DynamicCast<Aspose::Words::Fonts::FolderFontSource>(FontSettings::get_DefaultInstance()->GetFontsSources()->idx_get(1)));
...
void ExRendering::SetSpecifyFontFolder()
{
    ...
    SharedPtr<FolderFontSource> folderSource = (System::DynamicCast<Aspose::Words::Fonts::FolderFontSource>(doc->get_FontSettings()->GetFontsSources()->idx_get(0)));
...
void ExRendering::SetFontSubstitutes()
{
    //ExStart
    ...
    ArrayPtr<String> alternativeFonts = doc->get_FontSettings()->get_SubstitutionSettings()->get_TableSubstitution()->GetSubstitutes(u"Times New Roman")->LINQ_ToArray();
...
void ExRendering::SetSpecifyFontFolders()
{
    auto fontSettings = MakeObject<FontSettings>();
    ...
    folderSource = (System::DynamicCast<Aspose::Words::Fonts::FolderFontSource>(doc->get_FontSettings()->GetFontsSources()->idx_get(1)));
...
void ExRendering::AddFontSubstitutes()
{
    auto fontSettings = MakeObject<FontSettings>();
    ...
    ArrayPtr<String> alternativeFonts = doc->get_FontSettings()->get_SubstitutionSettings()->get_TableSubstitution()->GetSubstitutes(u"Slab")->LINQ_ToArray();
...
void ExRendering::SetDefaultFontName()
{
    //ExStart
...
void ExRendering::UpdatePageLayoutWarnings()
{
    // Store the font sources currently used so we can restore them later
    ArrayPtr<SharedPtr<FontSourceBase>> origFontSources = FontSettings::get_DefaultInstance()->GetFontsSources();
...
void ExRendering::EmbedFullFonts()
{
    //ExStart
...
void ExRendering::DisableEmbedWindowsFonts()
{
    //ExStart
    ...
    auto options = MakeObject<PdfSaveOptions>();
    options->set_FontEmbeddingMode(Aspose::Words::Saving::PdfFontEmbeddingMode::EmbedNone);
...
void ExRendering::DisableEmbedCoreFonts()
{
    //ExStart
...
void ExRendering::EncryptionPermissions()
{
    //ExStart
    ...
    encryptionDetails->set_Permissions(Aspose::Words::Saving::PdfPermissions::ModifyAnnotations | Aspose::Words::Saving::PdfPermissions::DocumentAssembly);
...
void ExRendering::SetNumeralFormat()
{
    //ExStart
    ...
    auto options = MakeObject<PdfSaveOptions>();
    options->set_NumeralFormat(Aspose::Words::Saving::NumeralFormat::EasternArabicIndic);
