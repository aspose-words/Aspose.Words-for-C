...
namespace
{
    void EmbeddSubsetFonts(System::SharedPtr<Document> doc, System::String const &dataDir)
    {
        // ExStart:EmbeddSubsetFonts
        // To subset fonts in the output PDF document, simply create new PdfSaveOptions and set EmbedFullFonts to false.
        System::SharedPtr<PdfSaveOptions> options = System::MakeObject<PdfSaveOptions>();
        options->set_EmbedFullFonts(false);
        System::String outputPath = dataDir + GetOutputFilePath(u"EmbeddedFontsInPDF.EmbeddSubsetFonts.pdf");
...
void EmbeddedFontsInPDF()
{
    ...
    System::String outputPath = dataDir + GetOutputFilePath(u"EmbeddedFontsInPDF.pdf");
